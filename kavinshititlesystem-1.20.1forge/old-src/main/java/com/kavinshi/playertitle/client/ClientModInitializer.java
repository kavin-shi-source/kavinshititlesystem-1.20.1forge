...
import com.kavinshi.playertitle.KavinshiPlayerTitleMod;
 ...
 */
@Mod.EventBusSubscriber(modid = KavinshiPlayerTitleMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
@OnlyIn(Dist.CLIENT)
    ...
    public static void onAddPackFinders(AddPackFindersEvent event) {
        if (event.getPackType() == PackType.CLIENT_RESOURCES) {
            ...
            try {
                ...
                String packId = KavinshiPlayerTitleMod.MOD_ID + "_fonts";
